...
def update_event_data():
    ...
    if THREE_WEEK_LIMIT:
       ...
       # events_url = 'http://jetzt.aufstehen.de/page/event/search_results?country=US&date_start=%(start_date)s&date_end=%(end_date)s&limit=10000&format=json' % {'start_date': start_date, 'end_date': end_date}
	events_url = 'http://jetzt.aufstehen.de/page/event/search_results?country=US&date_start=%(start_date)s&date_end=%(end_date)s&limit=10000&format=json' % {'start_date': start_date, 'end_date': end_date}
    events_url = 'http://jetzt.aufstehen.de/page/event/search_results?country=US&limit=5000&format=json'
    ...
    events_url_PR = 'http://jetzt.aufstehen.de/page/event/search_results?country=PR&limit=100&format=json'
